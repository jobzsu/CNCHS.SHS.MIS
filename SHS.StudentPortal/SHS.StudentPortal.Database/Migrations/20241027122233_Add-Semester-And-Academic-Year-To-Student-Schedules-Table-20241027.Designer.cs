...
namespace SHS.StudentPortal.Database.Migrations
{
    ...
    [Migration("20241027122233_Add-Semester-And-Academic-Year-To-Student-Schedules-Table-20241027")]
    partial class AddSemesterAndAcademicYearToStudentSchedulesTable20241027
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SHS.StudentPortal.Domain.Models.Section", b =>
                {
                    b.HasOne("SHS.StudentPortal.Domain.Models.InstructorInfo", "Adviser")
                        .WithOne("Section")
                        .HasForeignKey("SHS.StudentPortal.Domain.Models.Section", "AdviserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
